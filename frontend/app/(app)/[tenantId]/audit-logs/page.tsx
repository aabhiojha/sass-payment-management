...
export default function TenantAuditLogsPage({
  ...
  useEffect(() => {
    if (!isTenantAdmin) router.replace(`/${params.tenantId}/customers`)
  }, [isTenantAdmin, router, params.tenantId])
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["tenant-audit-logs", page, size, selectedActions, selectedResources, resourceIdInput, actorSearch],
    queryFn: () => auditApi.listTenant(page, size, filter),
    enabled: isTenantAdmin && !!accessToken,
  })
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Audit log"
        description="Timestamped record of every action taken within your workspace."
      />
          ...
          <EmptyState
            ...
            description={
              hasFilters
                ...
                : "Actions taken within your workspace will be recorded here."
            }
            action={
              hasFilters ? (
